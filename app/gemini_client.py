...
class GeminiClient:
    ...
    def analyze_video(self, clip_path: str) -> str:
        ...
        prompt = (
            "Bạn là trợ lý phân tích camera. Chỉ mô tả ngắn gọn (1–4 câu) những HÀNH ĐỘNG/BIẾN ĐỘNG xảy ra trong video, chú ý miêu tả rõ các hành động đặc biệt là của người"
