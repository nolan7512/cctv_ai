...
class GeminiClient:
    ...
    def analyze_video(self, clip_path: str) -> str:
        ...
        prompt = (
            "Bạn là trợ lý phân tích camera. Chỉ mô tả (1–5 câu) những HÀNH ĐỘNG/BIẾN ĐỘNG xảy ra trong video, chú ý miêu chi tiết và rõ các hành động đặc biệt là của người"
